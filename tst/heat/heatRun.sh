        ...
        do
          ...
          do
            ...
            do
              ...
              INP="--inpLibA ./@CMAKE_SHARED_LIBRARY_PREFIX@genheat@CMAKE_SHARED_LIBRARY_SUFFIX@"
              INP="${INP} --size#${s}#--weakScaling#${w}#--kappa#2.#quad#--lbd#1.#--dt#0.1#--debug#--inpEps#0.0001"
              ...
              unset LOG
              LOG="heat-size=${s}-ws=${w}-np=${n}-tol=${t}-metis=${M_LOG}-ksp=${KSP_LOG}-pc=${PC_LOG}"
